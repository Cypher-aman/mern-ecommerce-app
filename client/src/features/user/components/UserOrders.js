...
function UserOrders() {
  ...
  useEffect(() => {
    if (user) dispatch(fetchUserOrdersAsync(user.id));
  }, [dispatch, user]);
              ...
              {userOrders?.map((order, index) => (
                <div key={index}>
                  <div className="mx-auto mt-12 pb-8 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <p className="py-2">Shipping Address</p>
                    <div className="flex justify-between gap-x-6 px-5 py-5 border-sodivd border-2 border-gray-200">
